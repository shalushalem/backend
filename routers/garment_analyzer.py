...
print("Loading Garment Classification Model... This might take a moment.")
# Using CPU by default. Add device=0 if deploying to a GPU server!
...
SUB_CATEGORIES = {
    ...
    "outerwear and winter wear": ["blazer", "denim jacket", "leather jacket", "trench coat", "woolen sweater", "hoodie", "cardigan"],
